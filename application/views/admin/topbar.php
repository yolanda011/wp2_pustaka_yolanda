...
<div id="content-wrapper" class="d-flex flex-column">
 ...
 <div id="content">
 <!-- Topbar -->
 <nav class="navbar navbar-expand navbar-success bg-gradient-light text-grey topbar mb-4 static-top shadow">
 <!-- Sidebar Toggle (Topbar) -->
 <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
 <i class="fa fa-bars"></i>
 </button>
 <!-- Page Heading -->
 <h1 class="h3 mb-2 text-grey-800"><?= $judul; ?></h1>
 <!-- Topbar Navbar -->
...
<div class="dropdown-divider"></div>
 ...
 <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-grey-400"></i>Logout
 </a>
 </div>
 </li>
 </ul>
